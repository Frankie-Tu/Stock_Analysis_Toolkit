...
class SummaryScrap:
    ...
    def summary_scrap(self):
        ...
        for item in self.args:
            ...
            fifty2_week_range_value = fifty2_week_range.find_all('td', {'class': 'Ta(end) Fw(b) Lh(14px)'})[0]
            ...
            one_year_target = one_year_target[0].find_all('td', {'class': 'Ta(end) Fw(b) Lh(14px)'})
